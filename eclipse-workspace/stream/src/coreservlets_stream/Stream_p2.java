...
public class Stream_p2 {
	...
	public static void main(String[] args) {
		List<String> words = Arrays.asList("hi", "hello", "alo","h","e");
		...
		// comma:  "hi,hello,..."
		System.out.println(words.stream().reduce((s1,s2) -> s1 + "," + s2)); //console: Optional[hi,hello,alo]<> reduce("",..) -> "" remove optional
		System.out.println("t:"+words.stream().reduce((s1,s2) -> s1 + "," + s2).orElse("at least 2 elements")); 
		...
		System.out.println(words.stream().mapToInt(String::length).reduce(0,(a,b) -> a+b));
