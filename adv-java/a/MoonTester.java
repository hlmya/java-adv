...
public class MoonTester {
	...
	public void phaseNewMoon() {
		assertEquals("New Moon phase wrong", Optional.of(MoonPhase.PHASE0), MoonPhase.getPhase("New Moon"));
	}

	@Test
	public void phaseFullMoon() {
		assertEquals("Full Moon phase wrong", Optional.of(MoonPhase.PHASE14), MoonPhase.getPhase("Full Moon"));
	}
